  ...
  return (
    <section className="relative -mt-20 flex min-h-[100svh] items-end overflow-hidden bg-cream pb-16 pt-32 md:pb-24">
      <div className="absolute inset-0">
        <video src={heroVideo.url} autoPlay muted loop playsInline preload="metadata" poster={craftImg} disablePictureInPicture className="h-full w-full object-cover object-center opacity-95" />
